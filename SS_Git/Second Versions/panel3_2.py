...
# Contenido para Estudio Teórico
contenido_teorico = pn.Tabs(
...
# Contenido para Estudio Estadístico (puedes agregar gráficos y análisis estadísticos aquí)
contenido_estadistico = pn.pane.Markdown("<h3>Aquí irán los análisis estadísticos.</h3>")
...
# Funciones para manejar el cambio de contenido
def mostrar_contenido_teorico(event):
    dashboard[1] = contenido_teorico

def mostrar_contenido_estadistico(event):
    dashboard[1] = contenido_estadistico

# Crear botones
boton_teorico = pn.widgets.Button(name='Ir a Estudio Teórico')
boton_estadistico = pn.widgets.Button(name='Ir a Estudio Estadístico')

# Asociar botones a las funciones
boton_teorico.on_click(mostrar_contenido_teorico)
boton_estadistico.on_click(mostrar_contenido_estadistico)

# Diseño final del dashboard
dashboard = pn.Column(
    titulo,
    subtitulos,
    pn.Row(boton_teorico, boton_estadistico),
    contenido_teorico  # Comenzar con el contenido teórico
)
